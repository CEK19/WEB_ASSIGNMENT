...
-- Thời gian đã tạo: Th10 23, 2021 lúc 12:54 PM
...
--
-- Cơ sở dữ liệu: `webass`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `access_bag`
--
...
--
-- Đang đổ dữ liệu cho bảng `access_bag`
--
...
--
-- Cấu trúc bảng cho bảng `access_caps`
--
...
--
-- Đang đổ dữ liệu cho bảng `access_caps`
--
...
--
-- Cấu trúc bảng cho bảng `access_glass`
--
...
--
-- Đang đổ dữ liệu cho bảng `access_glass`
--
...
--
-- Cấu trúc bảng cho bảng `pants_jeans`
--
...
--
-- Đang đổ dữ liệu cho bảng `pants_jeans`
--
...
--
-- Cấu trúc bảng cho bảng `pants_jog`
--
...
--
-- Đang đổ dữ liệu cho bảng `pants_jog`
--
...
--
-- Cấu trúc bảng cho bảng `pants_lounges`
--
...
--
-- Đang đổ dữ liệu cho bảng `pants_lounges`
--
...
--
-- Cấu trúc bảng cho bảng `shirt_polo`
--
...
--
-- Đang đổ dữ liệu cho bảng `shirt_polo`
--
...
--
-- Cấu trúc bảng cho bảng `shirt_shirt`
--
...
--
-- Đang đổ dữ liệu cho bảng `shirt_shirt`
--
...
--
-- Cấu trúc bảng cho bảng `shirt_tshirt_vest`
--
...
--
-- Đang đổ dữ liệu cho bảng `shirt_tshirt_vest`
--
...
--
-- Cấu trúc bảng cho bảng `shoes_sandals_slippers`
--
...
--
-- Đang đổ dữ liệu cho bảng `shoes_sandals_slippers`
--
...
--
-- Cấu trúc bảng cho bảng `shoes_shocks`
--
...
--
-- Đang đổ dữ liệu cho bảng `shoes_shocks`
--
...
--
-- Cấu trúc bảng cho bảng `shoes_trainers`
--
...
--
-- Đang đổ dữ liệu cho bảng `shoes_trainers`
--
...
--
-- Chỉ mục cho bảng `access_bag`
--
ALTER TABLE `access_bag`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `access_caps`
--
ALTER TABLE `access_caps`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `access_glass`
--
...
--
-- Chỉ mục cho bảng `pants_jeans`
--
ALTER TABLE `pants_jeans`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `pants_jog`
--
ALTER TABLE `pants_jog`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `pants_lounges`
--
ALTER TABLE `pants_lounges`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `shirt_polo`
--
ALTER TABLE `shirt_polo`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `shirt_shirt`
--
ALTER TABLE `shirt_shirt`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `shirt_tshirt_vest`
--
ALTER TABLE `shirt_tshirt_vest`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `shoes_sandals_slippers`
--
ALTER TABLE `shoes_sandals_slippers`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `shoes_shocks`
--
ALTER TABLE `shoes_shocks`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `shoes_trainers`
--
...
--
-- AUTO_INCREMENT cho bảng `access_bag`
--
ALTER TABLE `access_bag`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `access_caps`
--
ALTER TABLE `access_caps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `access_glass`
--
ALTER TABLE `access_glass`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT cho bảng `pants_jeans`
--
ALTER TABLE `pants_jeans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `pants_jog`
--
ALTER TABLE `pants_jog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `pants_lounges`
--
ALTER TABLE `pants_lounges`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `shirt_polo`
--
ALTER TABLE `shirt_polo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `shirt_shirt`
--
ALTER TABLE `shirt_shirt`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `shirt_tshirt_vest`
--
ALTER TABLE `shirt_tshirt_vest`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `shoes_sandals_slippers`
--
ALTER TABLE `shoes_sandals_slippers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `shoes_shocks`
--
ALTER TABLE `shoes_shocks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `shoes_trainers`
--
ALTER TABLE `shoes_trainers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
