            ...
            <div class="my_content">
                ...
                <div class="d-flex mb-2 justify-content-center">
                    <button class="me-2 my_icon" type="button">
                        <svg class="ms-3 " width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button class="my_icon">
                        <svg class="ms-3" width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <button class="my_icon">
                        <svg class="ms-3" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
